		...
		<div class="goods_content fl mt10 ml10">
			...
			<div class="summary">
				...
				<div class="preview fl">
					<div class="midpic">
						<a href="<?=$good->images[0]->path."?imageMogr2/thumbnail/800x800"?>" class="jqzoom" rel="gal1">   <!-- 第一幅图片的大图 class 和 rel属性不能更改 -->
							<img src="<?=$good->images[0]->path."?imageMogr2/thumbnail/350x350"?>" alt="" />               <!-- 第一幅图片的中图 -->
						</a>
					</div>
					...
					<div class="smallpic">
						...
						<div class="smallpic_wrap">
							<ul>
								...
								<li class="<?=$k==0?"cur":""?>">
									<a class="<?=$k==0?"zoomThumbActive":""?>
                                    " href="javascript:void(0);" rel="{gallery: 'gal1', smallimage:
                                    '<?=$v->path."?imageMogr2/thumbnail/350x350"?>',
                                    largeimage: '<?=$v->path."?imageMogr2/thumbnail/800x800"?>'}">
                                        <img src="<?=$v->path."?imageMogr2/thumbnail/50x50"?>"></a>
								</li>
                                <?php endforeach?>
							</ul>
						</div>
